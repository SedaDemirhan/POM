...
public class C01_E2ETest2 {
    ...
    public  void RoomCreateTest() throws InterruptedException {
        ...
        actions.sendKeys(Keys.TAB).
                ...
                sendKeys(Keys.TAB).
                sendKeys(ConfigReader.getProperty("CHQAAddRoomFakerDescription")).
        ...
        Thread.sleep(2000);
        Assert.assertTrue(qaConcortPage.addRoomSuccessfulYazısı.isDisplayed());
        ...
        Assert.assertTrue(qaConcortPage.addRoomHotelRoomListYazısı.isDisplayed());
    }
}
