...
public class C03_Raporlama extends TestBaseRapor {
    ...
    public void test1() {
        ...
        extentTest.info("Nutellla için arama yapıldı");
        ...
        String sonuçYazısı= sonucSayisiElementi.getText();
        String sonucArray[]=sonuçYazısı.split(" ");
        int sonucSayısı=Integer.parseInt(sonucArray[2]);
        extentTest.info("sonuc yazısı int haline getirildi");
        Assert.assertTrue(sonucSayısı<1000);
        extentTest.pass("sonuc sayısının 1000'den az olduğu test edildi");
